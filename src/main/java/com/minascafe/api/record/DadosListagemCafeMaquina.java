  ...
  String observacoes, String referencia, String meieiro, int porcentagem_produtor, int porcentagem_meieiro) {
    ...
    public DadosListagemCafeMaquina(CafeMaquina cafe_maquina) {
        this(cafe_maquina.getLote(), cafe_maquina.getProdutor(), cafe_maquina.getApelido(), cafe_maquina.getStatus(), cafe_maquina.getData(),
             ...
             cafe_maquina.getObservacoes(), cafe_maquina.getReferencia(), cafe_maquina.getMeieiro(), cafe_maquina.getPorcentagem_produtor(), cafe_maquina.getPorcentagem_meieiro());
    }
}