...
//Resposta...
public class CafeCocoResponse<T>{ //'T'- Na instanciação da Classe, permite que você passe qualquer classe para ela. É genérica.
    ...
    public CafeCocoResponse() { //Construtor padrão
    }
